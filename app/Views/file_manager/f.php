...
<body>
    <div class="container">
        ...
        <div class="faculty-options">
            ...
            <a href="<?= base_url(relativePath: 'filemanager/faculty/FST/Ilmu Komputer'); ?>"
                class="faculty-button">Ilmu Komputer</a>
            ...
            <?php 
					...
					if(!empty($listdepartment)):
						foreach($listdepartment as $lkey => $lvalue):
							if($lvalue["faculty_id"]===$faculty):
								?>

            <a href="<?= base_url('filemanager/faculty/'.$lvalue["faculty_id"].'/'.$lvalue["department_name"].''); ?>"
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="<?= base_url($file['file_path']) ?>" download>Unduh</a></td>
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
